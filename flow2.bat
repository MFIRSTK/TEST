...
call :IsAdmin
title STEPHANCE RANK 1 IN HEART
sleep 800
    :MUD
    mode 170,70
chcp 65001
...
echo.                                                        %COL%[33m╚══════╝   ╚═╝   ╚══════╝╚═╝     ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═══╝ ╚═════╝╚══════╝      
echo.                                                                                 
echo.                                                                   %COL%[39m██%COL%[33m╗  %COL%[39m██%COL%[33m╗%COL%[39m██%COL%[33m╗%COL%[39m███%COL%[33m╗   %COL%[39m██%COL%[33m╗ %COL%[39m██████%COL%[33m╗      %COL%[39m██████%COL%[33m╗ %COL%[39m███████%COL%[33m╗                              
echo.                                                                   %COL%[39m██%COL%[33m║ %COL%[39m██%COL%[33m╔╝%COL%[39m██%COL%[33m║%COL%[39m████%COL%[33m╗  %COL%[39m██%COL%[33m║%COL%[39m██%COL%[33m╔════╝     %COL%[39m██%COL%[33m╔═══%COL%[39m██%COL%[33m╗%COL%[39m██%COL%[33m╔════╝                              
echo.                                                                   %COL%[39m█████%COL%[33m╔╝ %COL%[39m██%COL%[33m║%COL%[39m██%COL%[33m╔%COL%[39m██%COL%[33m╗ %COL%[39m██%COL%[33m║%COL%[39m██%COL%[33m║  %COL%[39m███%COL%[33m╗    %COL%[39m██%COL%[33m║   %COL%[39m██%COL%[33m║%COL%[39m█████%COL%[33m╗                                
echo.                                                                   %COL%[39m██%COL%[33m╔═%COL%[39m██%COL%[33m╗ %COL%[39m██%COL%[33m║%COL%[39m██%COL%[33m║╚%COL%[39m██%COL%[33m╗%COL%[39m██%COL%[33m║%COL%[39m██%COL%[33m║   %COL%[39m██%COL%[33m║    %COL%[39m██%COL%[33m║   %COL%[39m██%COL%[33m║%COL%[39m██%COL%[33m╔══╝                                
echo.                                                                   %COL%[39m██%COL%[33m║  %COL%[39m██%COL%[33m╗%COL%[39m██%COL%[33m║%COL%[39m██%COL%[33m║ ╚%COL%[39m████%COL%[33m║%COL%[33m╚%COL%[39m██████%COL%[33m╔╝    %COL%[33m╚%COL%[39m██████%COL%[33m╔╝%COL%[39m██%COL%[33m║                                   
echo.                                                                   %COL%[33m╚═╝  ╚═╝╚═╝╚═╝  ╚═══╝ ╚═════╝      ╚═════╝ ╚═╝                                   
echo.                                                                                
echo.                                                       %COL%[33m███████╗██╗   ██╗███████╗██████╗ ██╗   ██╗████████╗██╗  ██╗██╗███╗   ██╗ ██████╗ 
echo.                                                       %COL%[33m██╔════╝██║   ██║██╔════╝██╔══██╗╚██╗ ██╔╝╚══██╔══╝██║  ██║██║████╗  ██║██╔════╝ 
...
echo.                                                                                 
echo.
echo.                                                                 %COL%[33mREGARDING THE PROGRAM TRUST ME THE BALANCE AND SMOOTH
echo.                                                                     %COL%[39mTHIS IS PROGRAM AND THE SKILL ARE AT STEPHANCE
echo.                                                                        %COL%[33mMASTERPIECE OF THIS IS PROGRAM NEWSCRIPT
echo.                                ╔═══════════════════════════════════════════════════════════════%COL%[39m═══════════════════════════════════════════════════════════╗
echo.                                                                           %COL%[33mDeveloper : %COL%[39mMudxstephance
echo.                                                                    %COL%[39mContact : %COL%[33mMudxstephance   %COL%[39mContact : %COL%[33mMudxstephance                                                                                  
echo.                                %COL%[39m╚═══════════════════════════════════════════════════════════════%COL%[33m═══════════════════════════════════════════════════════════╝
echo.                                                                    
echo.                                                                              %COL%[33mMAIN MENU GODFATHER
echo.                                                                          %COL%[39m %COL%[33m↓ %COL%[39m10 OPTION BRUTAL NO FAKE %COL%[33m↓ %COL%[33m                                                                                  
echo.                                                                                                                                                                                 
echo.                                 %COL%[33m[ %COL%[39m1 %COL%[33m] %COL%[39mDASHMODE SOLO SKILL                 %COL%[33m[ %COL%[39m2 %COL%[33m] %COL%[39mBUILD INTERFACE 10MB               %COL%[33m[ %COL%[39m3 %COL%[33m] %COL%[39mHIGH EFFCICENCY
echo.                                 %COL%[33mFIX MOVEMENT FIVEM SMOOTH                 INTERNET PINGDAWN  9-10 MS               WIN WITH WEAPONS EASILY
echo.                                 %COL%[33mStephance King Of EveryThing              Stephance King Of EveryThing             Stephance King Of EveryThing 
echo.
echo.
echo.                                 %COL%[33m[ %COL%[39m4 %COL%[33m] %COL%[39mREDUCE DELAY 1 MS                   %COL%[33m[ %COL%[39m5 %COL%[33m] %COL%[39mFLOW SMOOTH THAN BEFORE            %COL%[33m[ %COL%[39m6 %COL%[33m] %COL%[39mBETCOIN TRAINNING / ANOTHER SERVER
echo.                                 %COL%[33mFIX MOUSE NODELAY                         PLAYING WILL BE BETTER                   1V1 ONLY BETCOIN WINFREE
echo.                                 %COL%[33mStephance King Of EveryThing              Stephance King Of EveryThing             Stephance King Of EveryThing 
echo.
echo.
echo.                                 %COL%[33m[ %COL%[39m7 %COL%[33m] %COL%[39mWEAPONSELECTED REAL                 %COL%[33m[ %COL%[39m8 %COL%[33m] %COL%[39mTEAMFIGHT NUA 10V10 40V40          %COL%[33m[ %COL%[39m9 %COL%[33m] %COL%[39mDNS/TCP BESTTER PERFORMANCE
echo.                                 %COL%[33mNO ONE CAN KILL YOU                       YOU ARE WIN IS THELASTCARD               HIGHHEST PREMIUM LEVEL 
echo.                                 %COL%[33mStephance King Of EveryThing              Stephance King Of EveryThing             Stephance King Of EveryThing 
echo.
echo.
echo.                                                                          %COL%[33m[ %COL%[39m10 %COL%[33m] %COL%[39mKEYBORD / MOUSE %COL%[33m= %COL%[39mNOT DELAY
echo.                                                                          %COL%[33mTURN CRISIS INTO AN OPPORTUNITY
echo.                                                                          %COL%[33mStephance King Of EveryThing      
echo. 
echo.
echo.
set /p input="%c%RUN PROGRAM WEAPONS OF GOD 1-10 %COL%[39m: %u% " 
if "%input%"=="1" goto 1
if "%input%"=="2" goto 2
if "%input%"=="3" goto 3
if "%input%"=="4" goto 4
